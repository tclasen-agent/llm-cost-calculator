 ...
 * Review frequency: With each related data review; check links monthly.
 * Update: Replace moved URLs only after confirming the same document scope; retain historical evidence.
...
export default {
  "maintenance": {
    ...
    "source": "Publisher/provider documents",
    "how": "Replace moved URLs only after confirming the same document scope; retain historical evidence."
  },
  "values": {
