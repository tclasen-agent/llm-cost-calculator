 ...
 * Update: Recalibrate memory/activation coefficients and monthly capacity allowance. Constants model a recipe, not a compatibility guarantee.
...
export default {
  "maintenance": {
    ...
    "source": "sources.training; training method documentation and pilots",
    "how": "Recalibrate memory/activation coefficients and monthly capacity allowance. Constants model a recipe, not a compatibility guarantee."
  },
  "values": {
    "usableMemory": 0.95,
